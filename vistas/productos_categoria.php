<?php
//cargo la categoria (categoria_url)
$categoriaSeleccionada  = isset($_GET['categoria']) ? $_GET['categoria'] : false;
$listado = Componente::listado_por_categoria($categoriaSeleccionada);
?>

<!-- SECCION 3 (filtro dos): productos x categoria-->
<?php if (!empty($listado)) { ?>
    <section class="container" id="productos-por-categoria">
...
<?php  } else { ?>
    <section id="error-404">
        <div class="container text-center">
            <h2>Error 404</h2>
            <p class="text-center">No se encontro la categoria/productos con esa categoria</p>
